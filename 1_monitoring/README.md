...
AphidEffects(data=ADD.Monitor.all.sub$DuckweedCoverage,Pond = Block,Time = ADD.Monitor.all.sub$Time,Treatment = ADD.Monitor.all.sub$Treatment,TimeRemove = 2, Parameters  = "./results/DuckweedCoverage");
...
AphidEffects(data=log(ADD.Monitor.all.sub$TotalDaphina_magna+1),Pond = Block,Time = ADD.Monitor.all.sub$Time,Treatment = ADD.Monitor.all.sub$Treatment,TimeRemove = 2,Parameters  = "./results/TotalDaphina_magna")
```
